...
module.exports = function make_handle_chunk() {
    return async function handle_chunk(msg, meta) {
        const seneca = this;
        ...
        debug('EMBED-OUT', batch, mark, chunker, embeder, podcast_id, episode_id, doEmbed, doStore, out);
        return out;
    };
};
...
//# sourceMappingURL=handle_chunk.js.map