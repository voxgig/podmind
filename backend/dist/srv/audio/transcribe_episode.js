...
module.exports = function make_transcribe_episode() {
    return async function transcribe_episode(msg, meta) {
        ...
        if (doAudio) {
            ...
            const res = await Deepgram.listen.prerecorded.transcribeFile(audioEnt.content, {
                diarize: true,
                paragraphs: true,
                punctuate: true,
...
//# sourceMappingURL=transcribe_episode.js.map